...
export const REGISTERED_PATIENTS = [
  ...
  { id: "DH-2026-0921", name: "Chisom Okonkwo", phone: "08098765432", payer: "HMO / Insurance" as PayerType, hmo: "Hygeia HMO" },
  { id: "DH-2026-1105", name: "Ibrahim Garba", phone: "08123456789", payer: "Corporate Retainership" as PayerType },
  { id: "DH-2026-1188", name: "Grace Effiong", phone: "07011223344", payer: "Private / Out-of-Pocket" as PayerType },
];

export default function BillingPage() {
  const [activeTab, setActiveTab] = useState<"invoices" | "patient-payments">("invoices");
    ...
    <div style={{ padding: "1.5rem", fontFamily: "system-ui, sans-serif", color: "#0f172a" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.2rem" }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: "0.875rem", color: "#64748b" }}>Linked patient registry billing, payment records, and printable receipts.</p>
        </div>
        <button
